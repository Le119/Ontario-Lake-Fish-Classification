...
set.seed(5)
rem<-sample(c(rep(0,589),rep(1,340)),929)
rem2<-sample(c(rep(0,76),rep(1,340)),416)
remove<-which(c(rem,rem2)==0)
x_data_train<-x_data_train[-c(remove),,]
y_data_train<-y_data_train[-remove]
...
set.seed(5)
rem<-sample(c(rep(0,142),rep(1,61)),203)
rem2<-rep(1,61)
rem3<-sample(c(rep(0,11),rep(1,61)),72)
...
set.seed(5)
rem<-sample(c(rep(0,42),rep(1,24)),66)
rem2<-rep(1,24)
rem3<-sample(c(rep(0,18),rep(1,24)),42)
remove<-which(c(rem,rem2,rem3)==0)
...
rnn %>%
  layer_simple_rnn(input_shape=c(5,249), units = 200, dropout = 0,
                   recurrent_dropout = 0,time_major=F) %>% # output shape is (batch_size, units)
